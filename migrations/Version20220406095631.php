 ...
 */
final class Version20220406095631 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mode_platform (mode_id INT NOT NULL, platform_id INT NOT NULL, INDEX IDX_3A35A45077E5854A (mode_id), INDEX IDX_3A35A450FFE6496F (platform_id), PRIMARY KEY(mode_id, platform_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
